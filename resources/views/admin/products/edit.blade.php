                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="number" name="design_service_price" id="design_service_price" class="form-control form-control-material" step="0.01" min="0" value="{{ $product->design_service_price }}">
                                    <span class="input-group-text">₺</span>
                                </div>
