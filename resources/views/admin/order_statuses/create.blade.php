...
<div class="page-header mb-4">
    <h1 class="page-title">Yeni Sipariş Durumu Ekle</h1>
    <p class="page-subtitle">Sipariş durumu bilgilerini girin</p>
</div>
    ...
    <div class="col-md-8">
        <div class="material-card-elevated">
            <div class="material-card-header">
                <h5><span class="material-icons" style="vertical-align:middle;margin-right:8px">add_task</span>Durum Bilgileri</h5>
            </div>
