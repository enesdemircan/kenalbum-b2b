...
@section('content')
    <h1>{{ $category->title }} - Parametre Düzenle</h1>
    <form action="{{ route('admin.customization-params.update', [$category->id, $param->id]) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="key" id="key" class="form-control" required value="{{ old('key', $param->key) }}">
        </div>
        ...
        <div class="mb-3" id="text_value_section" style="display: none;">
            ...
            <input type="text" name="value" id="value" class="form-control" value="{{ old('value', $param->value) }}">
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="number" name="order" id="order" class="form-control" value="{{ old('order', $param->order ?? 0) }}">
        </div>
