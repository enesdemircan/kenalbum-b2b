...
<div class="page-header d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <p class="page-subtitle">Rol ve route izinlerini tanımlayın</p>
    </div>
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" id="name" class="form-control form-control-material" value="{{ old('name') }}" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
                        <label for="description" class="form-label">Açıklama</label>
                        <textarea name="description" id="description" class="form-control form-control-material" rows="3">{{ old('description') }}</textarea>
                    </div>
                </div>
            </div>
