...
<div class="page-header d-flex justify-content-between align-items-center mb-4">
    <div>
        <h1 class="page-title">Yeni Tahsilat Ekle</h1>
        <p class="page-subtitle">Tahsilat bilgilerini girin</p>
    </div>
                ...
                <form action="{{ route('admin.collections.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="amount" id="amount" class="form-control form-control-material @error('amount') is-invalid @enderror" value="{{ old('amount') }}" step="0.01" min="0.01" max="999999999.99" placeholder="0.00" required>
                                    @error('amount')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="collection_date" id="collection_date" class="form-control form-control-material @error('collection_date') is-invalid @enderror" value="{{ old('collection_date', date('Y-m-d')) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="notes" id="notes" rows="3" class="form-control form-control-material @error('notes') is-invalid @enderror" placeholder="Tahsilat ile ilgili notlar...">{{ old('notes') }}</textarea>
                            @error('notes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
