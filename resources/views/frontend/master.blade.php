...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=latin-ext" rel="stylesheet">
...
<body>
  ...
  <svg class="d-none">
    ...
    <symbol id="icon_search" viewBox="0 0 20 20">
      <path d="M8.75 1.5625C4.80723 1.5625 1.5625 4.80723 1.5625 8.75C1.5625 12.6928 4.80723 15.9375 8.75 15.9375C10.4632 15.9375 12.0355 15.3375 13.2664 14.3448L17.2197 18.2981C17.5126 18.5909 17.9875 18.5909 18.2803 18.2981C18.5732 18.0052 18.5732 17.5303 18.2803 17.2375L14.327 13.2842C15.3197 12.053 15.9197 10.4807 15.9197 8.7675V8.75C15.9197 4.80723 12.6928 1.5625 8.75 1.5625ZM3.0625 8.75C3.0625 5.6358 5.6358 3.0625 8.75 3.0625C11.8642 3.0625 14.4375 5.6358 14.4375 8.75C14.4375 11.8642 11.8642 14.4375 8.75 14.4375C5.6358 14.4375 3.0625 11.8642 3.0625 8.75Z" fill="currentColor"/>
    </symbol>
    ...
    <symbol id="icon_logout" viewBox="0 0 20 20">
      <path d="M7.5 2.5C7.5 2.03976 7.16421 1.66667 6.75 1.66667H3.75C3.33579 1.66667 3 2.03976 3 2.5V17.5C3 17.9602 3.33579 18.3333 3.75 18.3333H6.75C7.16421 18.3333 7.5 17.9602 7.5 17.5V2.5Z" fill="currentColor"/>
      <path d="M12.5 6.66667L15.8333 10L12.5 13.3333" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M15.8333 10H5.83333" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
    </symbol>
  </svg>
  <!-- Mobile Header -->
  <div class="header-mobile header_sticky">
    <div class="container d-flex align-items-center h-100">
      ...
      <div class="logo">
        <a href="{{ route('home') }}">
          <img src="{{ $siteSettings->logo }}" alt="{{ $siteSettings->title }}" class="logo__image d-block">
        </a>
      </div><!-- /.logo -->
    ...
    <nav class="header-mobile__navigation navigation d-flex flex-column w-100 position-absolute top-100 bg-body overflow-auto">
      ...
      <div class="container">
        <div class="overflow-hidden">
          <ul class="navigation__list list-unstyled position-relative">
            ...
            @php
              $childCategories = $mainCategories->where('ust_id', $mainCategory->id);
            @endphp
                @if($childCategories->count() > 0)
                <li class="navigation__item">
                  <a href="{{ route('category.show', $mainCategory->slug) }}" class="navigation__link">{{ \App\Helpers\TurkishHelper::turkishToUpper($mainCategory->title) }}</a>
                  <div class="box-menu" style="width: 800px;">
                    <div class="col pe-4">
                  <ul class="sub-menu__list list-unstyled">
                    @foreach($childCategories as $childCategory)
                      <li class="sub-menu__item">
                        <a href="{{ route('category.show', $childCategory->slug) }}" class="menu-link menu-link_us-s"> {{ \App\Helpers\TurkishHelper::turkishToUpper($childCategory->title) }}</a>
                      </li>
                    @endforeach
                  </ul>
                    </div>
            ...
            <li class="navigation__item">
              <a href="{{ route('page.show', $page->slug) }}" class="navigation__link">{{ $page->title }}</a>
            </li>
            @endforeach
            @endif
      ...
      <div class="border-top mt-auto pb-2">
        ...
        <ul class="container social-links list-unstyled d-flex flex-wrap mb-0">
          ...
          <li>
            <a href="{{ $siteSettings->facebook }}" class="footer__social-link d-block ps-0">
          ...
          <li>
            <a href="{{ $siteSettings->twitter }}" class="footer__social-link d-block">
          ...
          <li>
            <a href="{{ $siteSettings->instagram }}" class="footer__social-link d-block">
          ...
          <li>
            <a href="{{ $siteSettings->youtube }}" class="footer__social-link d-block">
    ...
    <div class="header-top bg-black">
      <div class="container d-flex container color-white align-items-center">
        <ul class="list-unstyled d-flex flex-1 gap-3 m-0">
          @foreach($pages as $page)
            <li><a href="{{ route('page.show', $page->slug) }}" class="menu-link menu-link_us-s color-white">{{ $page->title }}</a></li>
          @endforeach
        </ul>
        <ul class="social-links list-unstyled d-flex flex-wrap mx-auto mb-0">
          @if($siteSettings->facebook)
          <li>
            <a href="{{ $siteSettings->facebook }}" class="footer__social-link d-block color-white">
              <svg class="svg-icon svg-icon_facebook" width="9" height="15" viewBox="0 0 9 15" xmlns="http://www.w3.org/2000/svg"><use href="#icon_facebook" /></svg>
            </a>
          </li>
          @endif
          @if($siteSettings->twitter)
          <li>
            <a href="{{ $siteSettings->twitter }}" class="footer__social-link d-block color-white">
              <svg class="svg-icon svg-icon_twitter" width="14" height="13" viewBox="0 0 14 13" xmlns="http://www.w3.org/2000/svg"><use href="#icon_twitter" /></svg>
            </a>
          </li>
          @endif
          @if($siteSettings->instagram)
          <li>
            <a href="{{ $siteSettings->instagram }}" class="footer__social-link d-block color-white">
              <svg class="svg-icon svg-icon_instagram" width="14" height="13" viewBox="0 0 14 13" xmlns="http://www.w3.org/2000/svg"><use href="#icon_instagram" /></svg>
            </a>
          </li>
          @endif
          @if($siteSettings->youtube)
          <li>
            <a href="{{ $siteSettings->youtube }}" class="footer__social-link d-block color-white">
              <svg class="svg-icon svg-icon_youtube" width="14" height="15" viewBox="0 0 14 15" xmlns="http://www.w3.org/2000/svg"><use href="#icon_youtube" /></svg>
            </a>
          </li>
          @endif
        </ul>
        ...
        <div class="container d-flex align-items-center my-2">
          <div class="flex-1 d-flex align-items-center gap-3">
            ...
            <div class="service-promotion__content-wrap">
              <h3 class="service-promotion__title h6 text-uppercase mb-0">Destek Hattı</h3>
              <p class="service-promotion__content fs-base mb-0">{{ $siteSettings->phone }}</p>
            </div>
          </div>
          <div class="logo">
            <a href="{{ route('home') }}">
              <img src="{{ $siteSettings->logo }}" alt="{{ $siteSettings->title }}" class="logo__image">
            </a>
          </div><!-- /.logo -->
          ...
          <div class="header-tools d-flex align-items-center flex-1 justify-content-end me-2">
            ...
            <a href="{{ route('cart.index') }}" class="header-tools__item header-tools__cart">
              <svg class="d-block" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><use href="#icon_cart" /></svg>
              <span class="cart-amount d-block position-absolute " >{{ $cartCount ?? 0 }}</span>
            </a>
          </div><!-- /.header__tools -->
        </div>
      </div><!-- /.header-middle -->
 ...
 @yield('content')
  ...
  <footer class="footer footer_type_1 dark">
    ...
    <div class="footer-middle container">
      <div class="row row-cols-lg-5 row-cols-2">
        <div class="footer-column footer-store-info col-12 mb-4 mb-lg-0">
          <div class="logo">
            <a href="{{ route('home') }}">
              <img src="{{ $siteSettings->logo_white }}" alt="{{ $siteSettings->title }}" class="logo__image d-block">
            </a>
          </div><!-- /.logo -->
          <p class="footer-address">{{ $siteSettings->address }}</p>

          <p class="m-0">
            <strong class="fw-medium">{{ $siteSettings->email }}</strong>
          </p>
          <p>
            <strong class="fw-medium">{{ $siteSettings->phone }}</strong>
          </p>

          <ul class="social-links list-unstyled d-flex flex-wrap mb-0">
            @if($siteSettings->facebook)
            <li>
              <a href="{{ $siteSettings->facebook }}" class="footer__social-link d-block">
                <svg class="svg-icon svg-icon_facebook" width="9" height="15" viewBox="0 0 9 15" xmlns="http://www.w3.org/2000/svg"><use href="#icon_facebook" /></svg>
              </a>
            </li>
            @endif
        ...
        <div class="footer-column footer-menu mb-4 mb-lg-0">
          <h6 class="sub-menu__title text-uppercase">Sayfalar</h6>
          <ul class="sub-menu__list list-unstyled">
            @foreach($pages as $page)
              <li class="sub-menu__item"><a href="{{ route('page.show', $page->slug) }}" class="menu-link menu-link_us-s">{{ $page->title }}</a></li>
            @endforeach
          </ul>
        </div><!-- /.footer-column -->
        ...
        <div class="footer-column footer-menu mb-4 mb-lg-0">
          ...
          <ul class="sub-menu__list list-unstyled">
            @foreach($mainCategories->where('ust_id', 0) as $mainCategory)
              <li class="sub-menu__item"><a href="{{ route('category.show', $mainCategory->slug) }}" class="menu-link menu-link_us-s">{{ $mainCategory->title }}</a></li>
            @endforeach
          </ul>
        </div><!-- /.footer-column -->
    ...
    <div class="footer-bottom container">
      <div class="d-block d-md-flex align-items-center">
        <span class="footer-copyright me-auto">Copyright © 2025, Created by
         <a style="color: #fff; font-weight: bold;" href="https://miselium.io"> Miselium Software</a></span>
  ...
  <footer class="footer-mobile container w-100 px-5 d-md-none bg-body">
    <div class="row text-center">
      ...
      <div class="col-4">
        <a href="{{ route('profile.index') }}" class="footer-mobile__link d-flex flex-column align-items-center">
      ...
      <div class="col-4">
        <form method="POST" action="{{ route('logout') }}" style="display: inline;">
          @csrf
          <button type="submit" class="footer-mobile__link d-flex flex-column align-items-center border-0 bg-transparent w-100">
            <svg class="d-inline-block align-middle" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><use href="#icon_logout" /></svg>
            <span>Çıkış Yap</span>
          </button>
        </form>
      </div><!-- /.col-3 -->
  ...
  <footer class="footer-mobile container w-100 px-5 d-md-none bg-body">
    <div class="row text-center">
      ...
      <div class="col-4">
        <a href="{{ route('register') }}" class="footer-mobile__link d-flex flex-column align-items-center">
          <svg class="d-inline-block align-middle" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><use href="#icon_user" /></svg>
